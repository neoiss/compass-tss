...
var _ protoreflect.Message = (*fastReflection_MsgTCYClaim)(nil)

type fastReflection_MsgTCYClaim MsgTCYClaim

func (x *MsgTCYClaim) ProtoReflect() protoreflect.Message {
	return (*fastReflection_MsgTCYClaim)(x)
}

func (x *MsgTCYClaim) slowProtoReflect() protoreflect.Message {
	mi := &file_types_msg_tcy_claim_proto_msgTypes[0]
...
var _fastReflection_MsgTCYClaim_messageType fastReflection_MsgTCYClaim_messageType
var _ protoreflect.MessageType = fastReflection_MsgTCYClaim_messageType{}

type fastReflection_MsgTCYClaim_messageType struct{}

func (x fastReflection_MsgTCYClaim_messageType) Zero() protoreflect.Message {
	return (*fastReflection_MsgTCYClaim)(nil)
}
func (x fastReflection_MsgTCYClaim_messageType) New() protoreflect.Message {
	return new(fastReflection_MsgTCYClaim)
}
func (x fastReflection_MsgTCYClaim_messageType) Descriptor() protoreflect.MessageDescriptor {
	return md_MsgTCYClaim
}

// Descriptor returns message descriptor, which contains only the protobuf
// type information for the message.
func (x *fastReflection_MsgTCYClaim) Descriptor() protoreflect.MessageDescriptor {
	return md_MsgTCYClaim
}
...
func (x *fastReflection_MsgTCYClaim) Type() protoreflect.MessageType {
	return _fastReflection_MsgTCYClaim_messageType
}

// New returns a newly allocated and mutable empty message.
func (x *fastReflection_MsgTCYClaim) New() protoreflect.Message {
	return new(fastReflection_MsgTCYClaim)
}

// Interface unwraps the message reflection interface and
// returns the underlying ProtoMessage interface.
func (x *fastReflection_MsgTCYClaim) Interface() protoreflect.ProtoMessage {
	return (*MsgTCYClaim)(x)
}
...
func (x *fastReflection_MsgTCYClaim) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	...
	if x.L1Address != "" {
		...
		if !f(fd_MsgTCYClaim_l1_address, value) {
			return
		}
	}
	if len(x.Signer) != 0 {
		value := protoreflect.ValueOfBytes(x.Signer)
		if !f(fd_MsgTCYClaim_signer, value) {
			return
		}
	}
}
...
func (x *fastReflection_MsgTCYClaim) Has(fd protoreflect.FieldDescriptor) bool {
	...
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: types.MsgTCYClaim"))
		}
		panic(fmt.Errorf("message types.MsgTCYClaim does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_MsgTCYClaim) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message types.MsgTCYClaim does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_MsgTCYClaim) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "types.MsgTCYClaim.signer":
		panic(fmt.Errorf("field signer of message types.MsgTCYClaim is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: types.MsgTCYClaim"))
		}
...
func (x *fastReflection_MsgTCYClaim) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in types.MsgTCYClaim", d.FullName()))
	}
	panic("unreachable")
}
...
func (x *fastReflection_MsgTCYClaim) GetUnknown() protoreflect.RawFields {
...
func (x *fastReflection_MsgTCYClaim) SetUnknown(fields protoreflect.RawFields) {
...
func (x *fastReflection_MsgTCYClaim) IsValid() bool {
	return x != nil
}
...
func (x *fastReflection_MsgTCYClaim) ProtoMethods() *protoiface.Methods {
	size := func(input protoiface.SizeInput) protoiface.SizeOutput {
		x := input.Message.Interface().(*MsgTCYClaim)
		if x == nil {
	...
	unmarshal := func(input protoiface.UnmarshalInput) (protoiface.UnmarshalOutput, error) {
		...
		for iNdEx < l {
			...
			if wireType == 4 {
				return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: MsgTCYClaim: wiretype end group for non-group")
			}
			if fieldNum <= 0 {
				return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: MsgTCYClaim: illegal tag %d (wire type %d)", fieldNum, wire)
			}
			switch fieldNum {
			case 1:
				if wireType != 2 {
...
func (x *MsgTCYClaim) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*MsgTCYClaim) ProtoMessage() {}

// Deprecated: Use MsgTCYClaim.ProtoReflect.Descriptor instead.
...
func (x *MsgTCYClaim) GetL1Address() string {
	if x != nil {
		return x.L1Address
	}
	return ""
...
func (x *MsgTCYClaim) GetSigner() []byte {
	if x != nil {
		return x.Signer
	}
	return nil
...
var File_types_msg_tcy_claim_proto protoreflect.FileDescriptor

var file_types_msg_tcy_claim_proto_rawDesc = []byte{
	0x0a, 0x19, 0x74, 0x79, 0x70, 0x65, 0x73, 0x2f, 0x6d, 0x73, 0x67, 0x5f, 0x74, 0x63, 0x79, 0x5f,
	0x63, 0x6c, 0x61, 0x69, 0x6d, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x05, 0x74, 0x79, 0x70,
	...
	0x22, 0x8f, 0x02, 0x0a, 0x0b, 0x4d, 0x73, 0x67, 0x54, 0x43, 0x59, 0x43, 0x6c, 0x61, 0x69, 0x6d,
	...
	0x65, 0x41, 0x64, 0x64, 0x72, 0x65, 0x73, 0x73, 0x12, 0x52, 0x0a, 0x0a, 0x6c, 0x31, 0x5f, 0x61,
	0x64, 0x64, 0x72, 0x65, 0x73, 0x73, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x42, 0x33, 0xfa, 0xde,
	...
	0x73, 0x52, 0x09, 0x6c, 0x31, 0x41, 0x64, 0x64, 0x72, 0x65, 0x73, 0x73, 0x12, 0x54, 0x0a, 0x06,
	...
	0x65, 0x72, 0x42, 0x7d, 0x0a, 0x09, 0x63, 0x6f, 0x6d, 0x2e, 0x74, 0x79, 0x70, 0x65, 0x73, 0x42,
	0x10, 0x4d, 0x73, 0x67, 0x54, 0x63, 0x79, 0x43, 0x6c, 0x61, 0x69, 0x6d, 0x50, 0x72, 0x6f, 0x74,
...
var (
	file_types_msg_tcy_claim_proto_rawDescOnce sync.Once
	file_types_msg_tcy_claim_proto_rawDescData = file_types_msg_tcy_claim_proto_rawDesc
)

func file_types_msg_tcy_claim_proto_rawDescGZIP() []byte {
	file_types_msg_tcy_claim_proto_rawDescOnce.Do(func() {
		file_types_msg_tcy_claim_proto_rawDescData = protoimpl.X.CompressGZIP(file_types_msg_tcy_claim_proto_rawDescData)
	})
	return file_types_msg_tcy_claim_proto_rawDescData
}

var file_types_msg_tcy_claim_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_types_msg_tcy_claim_proto_goTypes = []interface{}{
	(*MsgTCYClaim)(nil), // 0: types.MsgTCYClaim
}
var file_types_msg_tcy_claim_proto_depIdxs = []int32{
...
func init() { file_types_msg_tcy_claim_proto_init() }
func file_types_msg_tcy_claim_proto_init() {
	if File_types_msg_tcy_claim_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_types_msg_tcy_claim_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*MsgTCYClaim); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_types_msg_tcy_claim_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_types_msg_tcy_claim_proto_goTypes,
		DependencyIndexes: file_types_msg_tcy_claim_proto_depIdxs,
		MessageInfos:      file_types_msg_tcy_claim_proto_msgTypes,
	}.Build()
	File_types_msg_tcy_claim_proto = out.File
	file_types_msg_tcy_claim_proto_rawDesc = nil
	file_types_msg_tcy_claim_proto_goTypes = nil
	file_types_msg_tcy_claim_proto_depIdxs = nil
}
