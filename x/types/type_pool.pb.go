...
type Pool struct {
	...
	Asset               github_com_mapprotocol_compass_v3_common.Asset `protobuf:"bytes,3,opt,name=asset,proto3,customtype=github.com/mapprotocol/compass-tss/common.Asset" json:"asset"`
