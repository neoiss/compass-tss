...
func TestExceptionMemo(t *testing.T) {
	type args struct {
		chain   string
		orderID string
	}
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			if got := NewExceptionMemo(tt.args.chain, tt.args.orderID); got.String() != tt.want {
