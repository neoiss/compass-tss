...
// parseShortForm parses a string as as used in the Dogecoin Core reference tests
...
// TestCalcSignatureHash runs the Dogecoin Core signature hash calculation tests
// in sighash.json.
// https://github.com/dogecoin/dogecoin/blob/master/src/test/data/sighash.json
