// Copyright (c) 2013-2017 The eager7 developers
...
// in dogecoin core and in most if not all other references and software related
// to handling DOGE scripts.
const (
	OP_0                   = 0x00 // 0
	...
	OP_SMALLINTEGER        = 0xfa // 250 - dogecoin core internal
	OP_PUBKEYS             = 0xfb // 251 - dogecoin core internal
	OP_UNKNOWN252          = 0xfc // 252
	OP_PUBKEYHASH          = 0xfd // 253 - dogecoin core internal
	OP_PUBKEY              = 0xfe // 254 - dogecoin core internal
	OP_INVALIDOPCODE       = 0xff // 255 - dogecoin core internal
)
...
var opcodeArray = [256]opcode{
	...
	// Dogecoin Core internal use opcode.  Defined here for completeness.
